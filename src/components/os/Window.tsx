...
const Window: React.FC<WindowProps> = (props) => {
    ...
    const [isResizing, setIsResizing] = useState(false);  // window is being resized
    ...
    // completes and updates the size
    const stopResize = () => {
        setIsResizing(false);
            ...
            >
                <div style={styles.windowBorderOuter}>
                    ...
                    <div style={styles.windowBorderInner}>
                        ...
                        {/* invisible border for resizin the window */}
                        <div
